...
> = [
  ...
  { month: 9, day: 7, name: "Gloria Gaynor",  image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Gloria_Gaynor_2025_%28cropped%29.jpg/330px-Gloria_Gaynor_2025_%28cropped%29.jpg", profession: "Singer", region: "Global", star: "The voice behind I Will Survive, a timeless anthem of resilience.", wiki: "Gloria_Gaynor" },
  { month: 9, day: 7, name: "Queen Elizabeth I", image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/a/af/Darnley_stage_3.jpg/330px-Darnley_stage_3.jpg", profession: "Monarch", region: "Global", star: "The Virgin Queen who ruled England for 45 years and inspired an age of exploration.", wiki: "Elizabeth_I" },
  { month: 9, day: 7, name: "Evan Rachel Wood",  image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Evan_Rachel_Wood_%283x4_cropped%29.jpg/330px-Evan_Rachel_Wood_%283x4_cropped%29.jpg", profession: "Actor", region: "Hollywood", star: "A versatile actress known for Westworld, fearless in the roles she chooses.", wiki: "Evan_Rachel_Wood" },
  { month: 9, day: 7, name: "Kevin Love", image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/4/4a/Kevin_Love_and_Kyrie_Irving_%28cropped%29.jpg/330px-Kevin_Love_and_Kyrie_Irving_%28cropped%29.jpg", profession: "Basketball player", region: "Sports", star: "An NBA champion whose rebounding and three-point range redefined the power forward.", wiki: "Kevin_Love" },
  { month: 9, day: 7, name: "Leslie Jones", profession: "Comedian & actor", region: "Hollywood", star: "A Saturday Night Live original whose larger-than-life comedy fills every room.", wiki: "Leslie_Jones_(comedian)", image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/0/0f/Leslie_Jones_at_The_Stress_Factory_%2843785886122%29.jpg/330px-Leslie_Jones_at_The_Stress_Factory_%2843785886122%29.jpg" },
  { month: 9, day: 7, name: "Chrissie Hynde",  image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Chrissie_Hynde_2013.jpg/330px-Chrissie_Hynde_2013.jpg", profession: "Singer", region: "Global", star: "The magnetic frontwoman of The Pretenders, a rock voice for five decades.", wiki: "Chrissie_Hynde" },
  ...
  // ---- November ----
  { month: 11, day: 2, name: "Kendall Jenner", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Kendall_Jenner_for_Adanola_2_%28cropped%29.jpg/330px-Kendall_Jenner_for_Adanola_2_%28cropped%29.jpg", profession: "Model", region: "Global", star: "A supermodel whose effortless cool defined a new generation of fashion." },
  { month: 11, day: 9, name: "Carl Sagan", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Carl_Sagan_Planetary_Society.JPG/330px-Carl_Sagan_Planetary_Society.JPG", profession: "Astronomer", region: "Global", star: "The astronomer who made the cosmos feel personal and infinitely wondrous." },
  ...
  { month: 12, day: 16, name: "Arthur C. Clarke", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Arthur_C._Clarke_1965_%28cropped%29.jpg/330px-Arthur_C._Clarke_1965_%28cropped%29.jpg", profession: "Writer & futurist", region: "Global", star: "A visionary who imagined space and intelligence with prophetic clarity." },
...
function supplementToCelebriant(s: SupplementaryCelebrity): Celebrity {
  return {
    ...s,
    url: `https://en.wikipedia.org/wiki/${s.wiki ?? s.name.replace(/ /g, "_")}`,
  };
}
