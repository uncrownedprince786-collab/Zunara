...
> = [
  ...
  { month: 9, day: 7, name: "Gloria Gaynor", profession: "Singer", region: "Global", star: "The voice behind I Will Survive, a timeless anthem of resilience.", wiki: "Gloria_Gaynor" },
  { month: 9, day: 7, name: "Queen Elizabeth I", profession: "Monarch", region: "Global", star: "The Virgin Queen who ruled England for 45 years and inspired an age of exploration.", wiki: "Elizabeth_I" },
  { month: 9, day: 7, name: "Evan Rachel Wood", profession: "Actor", region: "Hollywood", star: "A versatile actress known for Westworld, fearless in the roles she chooses.", wiki: "Evan_Rachel_Wood" },
  { month: 9, day: 7, name: "Kevin Love", profession: "Basketball player", region: "Sports", star: "An NBA champion whose rebounding and three-point range redefined the power forward.", wiki: "Kevin_Love" },
  ...
  { month: 9, day: 7, name: "Chrissie Hynde", profession: "Singer", region: "Global", star: "The magnetic frontwoman of The Pretenders, a rock voice for five decades.", wiki: "Chrissie_Hynde" },
